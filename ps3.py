...
class RectangularRoom(object):
    ...
    def __init__(self, width, height, dirt_amount):
        ...
        for x in range(self.width):
            ...
            for y in range(self.height):
                self.room[x].append(self.dirt_amount)    
    ...
    def clean_tile_at_position(self, pos, capacity):
        ...
        cleaned_tile = tile - capacity
        if cleaned_tile < 0:
            cleaned_tile = 0
        self.room[x][y] = cleaned_tile
    ...
    def get_num_cleaned_tiles(self):
        ...
        """
        cleaned_tiles = 0
        for row_of_tiles in self.room.values():
    ...
    def get_dirt_amount(self, m, n):
        ...
        Returns: an integer
        """
        return math.floor(self.room[m][n])
...
class EmptyRoom(RectangularRoom):
    ...
    def get_random_position(self):
        ...
        """
        x = random.randint(0, self.width - 1) + random.random()
        y = random.randint(0, self.height - 1) + random.random()
...
class FurnishedRoom(RectangularRoom):
    ...
    def get_random_position(self):
        ...
        for furniture_tile in self.furniture_tiles:
            room_tiles.remove(furniture_tile)

        tile = random.choice(room_tiles)
        x = tile[0] + random.random()
        y = tile[1] + random.random()
        position = Position(x, y)
...
class StandardRobot(Robot):
    ...
    def update_position_and_clean(self):
        ...
        if self.room.is_position_valid(new_pos): 
            ...
            new_angle = random.randint(0, 359) + random.random()
...
# === Problem 5
def create_room(width, height, dirt_amount):
    """
    Creates a room
    Returns: An empty room object  
    """
    return EmptyRoom(width, height, dirt_amount)

def create_robots(room, num_robots, robot_type, speed, capacity):
    """ Creates the necessary amount of robots.
        Returns: A list containing all the robots
    """
    robots = []
...
def run_trial(room, robots, min_coverage):
    """ Creates a single trial that cleans the room up to a certain percentage
        Returns: an integer; the number of time steps to complete the trial
    """
    total_tiles = room.get_num_tiles()
    time_steps = 0
    percentage_clean = 0
    while percentage_clean < min_coverage:
        for robot in robots:
            robot.update_position_and_clean()
        time_steps += 1
        cleaned_tiles = room.get_num_cleaned_tiles()    
        percentage_clean = cleaned_tiles / total_tiles
    return time_steps    
...
def run_simulation(num_robots, speed, capacity, width, height, dirt_amount, min_coverage, num_trials,
    ...
    for trial in range(num_trials):
        ...
        robots = create_robots(room, num_robots, robot_type, speed, capacity)
        time_steps = run_trial(room, robots, min_coverage)
